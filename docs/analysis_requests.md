...
```
请你分析当前项目：
- active-sessions-utils.ts：`src/actions/active-sessions-utils.ts` (42 lines)
- active-sessions.ts：`src/actions/active-sessions.ts` (893 lines)
...
```
请你分析当前项目：
- error-rules.ts：`src/actions/error-rules.ts` (608 lines)
- keys.ts：`src/actions/keys.ts` (548 lines)
...
```
请你分析当前项目：
- overview.ts：`src/actions/overview.ts` (98 lines)
- provider-slots.ts：`src/actions/provider-slots.ts` (103 lines)
...
```
请你分析当前项目：
- request-filters.ts：`src/actions/request-filters.ts` (178 lines)
- sensitive-words.ts：`src/actions/sensitive-words.ts` (261 lines)
...
```
请你分析当前项目：
- favicon.ico：`src/app/favicon.ico` (77 lines)
...
```
请你分析当前项目：
- dashboard-header.tsx：`src/app/[locale]/dashboard/_components/dashboard-header.tsx` (51 lines)
- dashboard-nav.tsx：`src/app/[locale]/dashboard/_components/dashboard-nav.tsx` (63 lines)
...
```
请你分析当前项目：
- chart.tsx：`src/app/[locale]/dashboard/_components/statistics/chart.tsx` (595 lines)
...
```
请你分析当前项目：
- add-user-dialog.tsx：`src/app/[locale]/dashboard/_components/user/add-user-dialog.tsx` (44 lines)
- key-actions.tsx：`src/app/[locale]/dashboard/_components/user/key-actions.tsx` (86 lines)
...
```
请你分析当前项目：
- add-key-form.tsx：`src/app/[locale]/dashboard/_components/user/forms/add-key-form.tsx` (334 lines)
- delete-key-confirm.tsx：`src/app/[locale]/dashboard/_components/user/forms/delete-key-confirm.tsx` (71 lines)
...
```
请你分析当前项目：
- error-details-dialog.tsx：`src/app/[locale]/dashboard/logs/_components/error-details-dialog.tsx` (654 lines)
- logs-date-range-picker.tsx：`src/app/[locale]/dashboard/logs/_components/logs-date-range-picker.tsx` (246 lines)
...
```
请你分析当前项目：
- edit-key-quota-dialog.tsx：`src/app/[locale]/dashboard/quotas/keys/_components/edit-key-quota-dialog.tsx` (357 lines)
...
```
请你分析当前项目：
- provider-quota-list-item.tsx：`src/app/[locale]/dashboard/quotas/providers/_components/provider-quota-list-item.tsx` (228 lines)
...
```
请你分析当前项目：
- types.ts：`src/app/[locale]/dashboard/quotas/users/_components/types.ts` (49 lines)
...
```
请你分析当前项目：
- expiration-info.tsx：`src/app/[locale]/my-usage/_components/expiration-info.tsx` (89 lines)
- my-usage-header.tsx：`src/app/[locale]/my-usage/_components/my-usage-header.tsx` (113 lines)
...
```
请你分析当前项目：
- database-export.tsx：`src/app/[locale]/settings/data/_components/database-export.tsx` (63 lines)
...
```
请你分析当前项目：
- add-rule-dialog.tsx：`src/app/[locale]/settings/error-rules/_components/add-rule-dialog.tsx` (232 lines)
- edit-rule-dialog.tsx：`src/app/[locale]/settings/error-rules/_components/edit-rule-dialog.tsx` (250 lines)
...
```
请你分析当前项目：
- add-provider-dialog.tsx：`src/app/[locale]/settings/providers/_components/add-provider-dialog.tsx` (39 lines)
- model-multi-select.tsx：`src/app/[locale]/settings/providers/_components/model-multi-select.tsx` (218 lines)
...
```
请你分析当前项目：
- provider-manager.tsx：`src/app/[locale]/settings/providers/_components/provider-manager.tsx` (146 lines)
- provider-rich-list-item.tsx：`src/app/[locale]/settings/providers/_components/provider-rich-list-item.tsx` (539 lines)
...
```
请你分析当前项目：
- api-test-button.tsx：`src/app/[locale]/settings/providers/_components/forms/api-test-button.tsx` (594 lines)
- provider-form.tsx：`src/app/[locale]/settings/providers/_components/forms/provider-form.tsx` (1782 lines)
...
```
请你分析当前项目：
- add-word-dialog.tsx：`src/app/[locale]/settings/sensitive-words/_components/add-word-dialog.tsx` (146 lines)
...
```
请你分析当前项目：
- cors.ts：`src/app/v1/_lib/cors.ts` (165 lines)
...
```
请你分析当前项目：
- index.ts：`src/app/v1/_lib/converters/index.ts` (50 lines)
...
```
请你分析当前项目：
- adapter.ts：`src/app/v1/_lib/gemini/adapter.ts` (277 lines)
...
```
请你分析当前项目：
- auth-guard.ts：`src/app/v1/_lib/proxy/auth-guard.ts` (144 lines)
- error-handler.ts：`src/app/v1/_lib/proxy/error-handler.ts` (325 lines)
...
```
请你分析当前项目：
- guard-pipeline.ts：`src/app/v1/_lib/proxy/guard-pipeline.ts` (157 lines)
- mcp-passthrough-handler.ts：`src/app/v1/_lib/proxy/mcp-passthrough-handler.ts` (319 lines)
...
```
请你分析当前项目：
- rate-limit-guard.ts：`src/app/v1/_lib/proxy/rate-limit-guard.ts` (288 lines)
- request-filter.ts：`src/app/v1/_lib/proxy/request-filter.ts` (22 lines)
...
```
请你分析当前项目：
- active-sessions-list.tsx：`src/components/customs/active-sessions-list.tsx` (113 lines)
- active-sessions-panel.tsx：`src/components/customs/active-sessions-panel.tsx` (15 lines)
...
```
请你分析当前项目：
- overview-panel.tsx：`src/components/customs/overview-panel.tsx` (112 lines)
- session-card.tsx：`src/components/customs/session-card.tsx` (144 lines)
...
```
请你分析当前项目：
- quota-countdown.tsx：`src/components/quota/quota-countdown.tsx` (191 lines)
- quota-progress.tsx：`src/components/quota/quota-progress.tsx` (38 lines)
...
```
请你分析当前项目：
- alert-dialog.tsx：`src/components/ui/alert-dialog.tsx` (134 lines)
- alert.tsx：`src/components/ui/alert.tsx` (49 lines)
...
```
请你分析当前项目：
- calendar.tsx：`src/components/ui/calendar.tsx` (179 lines)
- card.tsx：`src/components/ui/card.tsx` (77 lines)
...
```
请你分析当前项目：
- collapsible.tsx：`src/components/ui/collapsible.tsx` (21 lines)
- command.tsx：`src/components/ui/command.tsx` (160 lines)
...
```
请你分析当前项目：
- dropdown-menu.tsx：`src/components/ui/dropdown-menu.tsx` (228 lines)
- input.tsx：`src/components/ui/input.tsx` (21 lines)
...
```
请你分析当前项目：
- popover.tsx：`src/components/ui/popover.tsx` (42 lines)
- progress.tsx：`src/components/ui/progress.tsx` (28 lines)
...
```
请你分析当前项目：
- sheet.tsx：`src/components/ui/sheet.tsx` (130 lines)
- skeleton.tsx：`src/components/ui/skeleton.tsx` (13 lines)
...
```
请你分析当前项目：
- table.tsx：`src/components/ui/table.tsx` (92 lines)
- tabs.tsx：`src/components/ui/tabs.tsx` (54 lines)
...
```
请你分析当前项目：
- README.md：`src/i18n/README.md` (197 lines)
- config.ts：`src/i18n/config.ts` (31 lines)
...
```
请你分析当前项目：
- async-task-manager.ts：`src/lib/async-task-manager.ts` (233 lines)
- auth.ts：`src/lib/auth.ts` (126 lines)
...
```
请你分析当前项目：
- client-version-checker.ts：`src/lib/client-version-checker.ts` (371 lines)
- codex-instructions-cache.ts：`src/lib/codex-instructions-cache.ts` (146 lines)
...
```
请你分析当前项目：
- event-emitter.ts：`src/lib/event-emitter.ts` (55 lines)
- logger.ts：`src/lib/logger.ts` (115 lines)
...
```
请你分析当前项目：
- provider-type-utils.tsx：`src/lib/provider-type-utils.tsx` (67 lines)
- proxy-agent.ts：`src/lib/proxy-agent.ts` (224 lines)
...
```
请你分析当前项目：
- session-manager.ts：`src/lib/session-manager.ts` (1562 lines)
...
```
请你分析当前项目：
- config.ts：`src/lib/config/config.ts` (13 lines)
...
```
请你分析当前项目：
- backup-lock.ts：`src/lib/database-backup/backup-lock.ts` (229 lines)
...
```
请你分析当前项目：
- index.ts：`src/lib/provider-testing/index.ts` (57 lines)
...
```
请你分析当前项目：
- cc_base.json：`src/lib/provider-testing/data/cc_base.json` (29 lines)
...
```
请你分析当前项目：
- anthropic-parser.ts：`src/lib/provider-testing/parsers/anthropic-parser.ts` (102 lines)
- codex-parser.ts：`src/lib/provider-testing/parsers/codex-parser.ts` (135 lines)
...
```
请你分析当前项目：
- circuit-breaker-config.ts：`src/lib/redis/circuit-breaker-config.ts` (202 lines)
- circuit-breaker-state.ts：`src/lib/redis/circuit-breaker-state.ts` (247 lines)
...
```
请你分析当前项目：
- clipboard.ts：`src/lib/utils/clipboard.ts` (30 lines)
- cn.ts：`src/lib/utils/cn.ts` (9 lines)
...
```
请你分析当前项目：
- date-format.ts：`src/lib/utils/date-format.ts` (148 lines)
- date.ts：`src/lib/utils/date.ts` (59 lines)
...
```
请你分析当前项目：
- quota-helpers.ts：`src/lib/utils/quota-helpers.ts` (183 lines)
...
```
请你分析当前项目：
- activity-stream.ts：`src/repository/activity-stream.ts` (229 lines)
- client-versions.ts：`src/repository/client-versions.ts` (61 lines)
...
```
请你分析当前项目：
- leaderboard.ts：`src/repository/leaderboard.ts` (373 lines)
- message.ts：`src/repository/message.ts` (716 lines)
...
```
请你分析当前项目：
- provider.ts：`src/repository/provider.ts` (576 lines)
- request-filters.ts：`src/repository/request-filters.ts` (156 lines)
...
```
请你分析当前项目：
- cache.ts：`src/types/cache.ts` (5 lines)
- database-backup.ts：`src/types/database-backup.ts` (41 lines)
...
```
请你分析当前项目：
- provider.ts：`src/types/provider.ts` (301 lines)
- proxy-status.ts：`src/types/proxy-status.ts` (89 lines)
...
```
请你分析当前项目：
- system-config.ts：`src/types/system-config.ts` (61 lines)
- user.ts：`src/types/user.ts` (132 lines)
